...
public class AepFactsDatabase {
    ...
    public AepFactsDatabase() {
        ...
        data.put("mike", miniBiog("Mike is just trying to make his way in this crazy world", "http://transparent-aluminium.net/wp-content/uploads/2013/06/Chuck-Norris-Tuesday-9.jpg"));
