...
public class AepFactsDatabase {
    ...
    public AepFactsDatabase() {
        ...
        data.put("AD", miniBiog("This may have taken me all day... But I have landed!!! #GitNewbie", "http://images2.fanpop.com/images/photos/2900000/LOL-CATS-lol-cats-2985219-772-726.jpg"));
